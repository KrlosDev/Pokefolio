...
const Contact = () => {
  ...
  return (
    ...
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex overflow-hidden'>
      <motion.div variants={fadeIn("down", "spring", 0.2, 1)} className='rounded-2xl green-pink-gradient p-1 max-w-[500px] min-w-[320px] m-auto'>
        ...
        <form ref={formRef} onSubmit={handleSubmit}
          ...
          <label className='flex flex-col'><span className='text-white font-medium mb-4'>Your Name</span>
            <input
              ...
              className='bg-secondary py-4 px-6 rounded-lg placeholder:text-white text-white outline-none border-none font-medium' />
          </label>
          ...
          <button type='submit' className='bg-tertiary py-3 px-8 outline-none w-fit mx-auto text-white font-bold shadow-md shadow-primary rounded-xl hover:bg-emerald-900'>
