...
const ProjectCard = ({index, name, description, tags, image, source_code_link})=>{
  return(
    <motion.div variants={fadeIn("up","spring",index*0.5, 0.75)}>
      <Tilt options={{max:45, scale:1, speed:450}} className="bg-primary p-5 rounded-2xl sm:w-[360px] w-full">
        ...
        <div className='mt-5'>
          ...
          <p className='text-white mt-2 text-[14px] min-h-[100px] max-h-[100px]'>{description}</p>
        </div>
...
const Works = () => {
  ...
  <div className='w-full flex'>
    <motion.p variants={fadeIn("","", 0.1, 0.5)} className='mt-3 text-primary text-[17px] max-w-3xl leading-[30px]'>
