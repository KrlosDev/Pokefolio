      ...
      <section style={glass}>
        <div className="max-w-screen-xl px-4 py-6 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
          <div className="flex justify-center mt-8 space-x-6">
            <a href="https://github.com/KrlosDev" className="text-white hover:text-secondary">
            ...
            <a href="https://www.linkedin.com/in/carlosabh/" className="text-white hover:text-secondary">
